...
def print_query(view_name:str):
    ...
    while menu_choice != 'Z':
        ...
        if menu_choice =='A':
            print_query('Show all schools')
        elif menu_choice == 'B':
            print_query('How many schools')
        elif menu_choice == 'C':
            print_query('All public schools')
        elif menu_choice == 'D':
            print_query('Composite schools')
        elif menu_choice == 'E':
            print_query('Boys schools')
        elif menu_choice == 'F':
            print_query('Schools with more than 2000 studnets')
        elif menu_choice == 'G':
            print_query('School name year established before 1900')
        elif menu_choice == 'H:
            print_query('Girls private schools')
        elif menu_choice == 'I':
            print_query('Schools from newest to oldest')
        elif menu_choice == 'J':
            print_query('Schools for girl only')
        elif menu_choice 
